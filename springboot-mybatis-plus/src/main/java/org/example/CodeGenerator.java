...
public class CodeGenerator {
    ...
    private static final String DB_NAEM = "fund";
    private static final boolean ALL_TABLE = false;
    private static final String GLOBAL_OUTPUT_DIR = "/springboot-mybatis-plus/src/main/java/org/example";
    ...
    private static DataSourceConfig getDataSourceConfig(){
        return new DataSourceConfig()
                ...
                .setUrl("jdbc:mysql://127.0.0.1:3306/" + DB_NAEM + "?noAccessToProcedureBodies=true&useSSL=false&serverTimezone=Asia/Shanghai&useSSL=false")
                .setUsername("root")
                .setPassword("123456")
